		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#assigment2ui-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"assigment2ui-display": {
								"semanticObject": "assigment2ui",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=assigment2ui",
									"url": sap.ui.require.toUrl("assigment2ui")
								}
							}
						}
					}
